const Welcomeview = () => {
  return (
    <div className="select-none w-full h-full text-slate-800 flex flex-col items-center justify-center">
      <svg
        className="w-40 h-40 mt-4 fill-slate-800"
      ...
      <p className="mt-8 text-gray-400">
        Ask your question in any language you want
      </p>
    </div>
  );
};
